...
if __name__ == '__main__':
    ...
    parser.add_argument("-raw_path", default='../../line_data', help="data input path")
    parser.add_argument("-save_path", default='../../data/', help="output path")
    parser.add_argument("-index_file", default='yi_test.txt', help="points to an index of files in raw_path")
