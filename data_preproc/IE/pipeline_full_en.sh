...
docker run --rm -v ${ltf_source}:${ltf_source} -v ${rsd_source}:${rsd_source} \
	-i limanling/uiuc_ie_m36 /opt/conda/envs/py36/bin/python /aida_utilities/rsd2ltf.py \
	--seg_option nltk+linebreak --tok_option nltk_wordpunct --extension .rsd.txt ${rsd_source} ${ltf_source}
